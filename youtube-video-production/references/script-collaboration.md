...
台本の初稿提示、部分修正、コメント反映、読み戻しでは、エージェントレビューを自動実行しない。

台本全体の完成後にユーザーからレビューを明示的に依頼された場合だけ、依頼された観点と範囲でレビューする。レビューは現在の作業担当者が行ってよく、別のレビューエージェントを必須にしない。レビュー後の修正確認も、ユーザーから追加依頼がない限り自動で繰り返さない。

台本レビューと台本の人間承認は別に扱い、レビュー依頼やレビュー完了を台本確定の意思表示として記録しない。

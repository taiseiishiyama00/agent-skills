...
文章には、現在の目的と読者の判断・行動に必要な情報だけを置く。情報の追加先や分け方を決めるときは、YAGNIとMECEを次の意味で適用する。

### YAGNI

- 現在の依頼、決定、運用に必要な情報だけを記載する。
- 将来使うかもしれない機能、属性、役割、節、ファイル、フォルダ、運用を先回りして追加しない。
- 既存の置き場所では管理しづらいことが確認できた時点で追加・分割する。
- 仮定や未決定事項を、確定した要件や決定事項として書かない。

### MECE

- 文書の目的に必要な範囲を、漏れと重複がない分類へ整理する。
- 同じ内容を複数の節やファイルへ複製せず、正本を一つにして必要箇所から参照する。
- 分類が重なる場合は、その情報を更新する責任が最も明確な場所へ置く。
- 一つの項目には一つの主題だけを記載する。
...
7. 最後に確認する。
   - 読者、目的、次の行動が明確か。
   - 現在は不要な将来用の項目や構造を追加していないか。
   - 必要な範囲に漏れがなく、同じ内容を複数箇所へ重複させていないか。
   - 構成が内容の流れに合っているか。
